...
**Building your own foundation model**. An LLM is a foundational model trained on the world's corpus of data. Similarly, you can train a foundation model on your own specific data if you have access to training software. In this case with a software that can train a generative model you can do the following: 
...
**Building constraints augmented foundation model** 
