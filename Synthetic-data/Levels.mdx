...
Data generated this way will emulate the statistical properties in your real data, it will be rich in information. It will capture all the salient patterns seen in your real data and emulate that in synthetic data (without repeating your real data points). To get it to Type 4, you may have to do some post processing. 
