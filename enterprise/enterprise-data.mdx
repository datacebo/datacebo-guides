---
title: "Data"
description: "This page highlights the various complexities of tabular data in enterprise settings that an AI model training software must handle."
---

Tabular data within enterprises is not as clean and pristine as AI modeling approaches need to be trained on. This has been a fundamental bottleneck for wide scale adoption both in development of predictive AI and generative AI models. In this article we highlight some of the most common complexities we have seen in our enterprise deployments. At the end of the article we present a questionaire you can use to assess whether a software is ready to ingest enterprise data and train an AI model. 
