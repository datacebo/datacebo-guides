...
- **Robust Evaluation Metrics:** Evaluation should rely only on openly validated, peer-reviewed metrics from academia and industry. We created [**<u><u>SDMetrics </u></u>**](https://docs.sdv.dev/sdmetrics)for this purpose, and it has become widely adopted across both domains.
...
- **Part 2** [_<u><u><u>introduces our trust-but-verify framework</u></u></u>_](https://datacebo.com/blog/differential-privacy-2/), which enables independent verification of the privacy guarantees for a synthesizer.