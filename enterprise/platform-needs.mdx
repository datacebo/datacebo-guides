...
| Address the sprawl of data types | Be able to model and synthesize data of a variety of types. These include the statistical types like numerical and categorical, but also include wide range of data types like phone numbers, addresses, vehicle identification numbers (VIN), GPS coordinates and many more. |
| -------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
