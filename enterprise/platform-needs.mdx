...
<Note>
  Different use cases demand different levels of quality, transparency, speed and privacy, and present extremen data constraints. No single model can be good along all axes. Thus a platform must delibrately address these by providing specialized modeling techniques that can help a variety of use cases. 
</Note>
